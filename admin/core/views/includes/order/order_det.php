<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
                <li class="active">
                    <i class="fa fa-home"></i> <a href="<?php echo site_url('page=home') ?>">Beranda</a> >> <a href="<?php echo site_url('page=order&act=order_list') ?>">Data Transaksi</a> >> Transaksi Detail
                </li>
            </ol>
        </div>
