...
if($_SERVER['HTTP_HOST'] != 'localhost'){
    define('SITE_URL', 'http://'.$_SERVER['HTTP_HOST'].'/assets');
}else{
    define('SITE_URL', 'http://'.$_SERVER['HTTP_HOST'].'/branded');
}
...
$upload_dir = '/web/images/source/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../../../web/images/source/'; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = '../../../web/images/thumbs/'; // relative path from filemanager folder to thumbs folder (with final /)
